...
protocol FilterOperationInterface: class {
...
class FilterOperation<FilterClass: GPUImageOutput>: FilterOperationInterface where FilterClass: GPUImageInput {
    ...
    var filter: GPUImageOutput? {
        if self.internalFilter is GPUImageAmatorkaFilter || self.internalFilter is GPUImageMissEtikateFilter || self.internalFilter is GPUImageSoftEleganceFilter {
            return FilterClass()
        }
